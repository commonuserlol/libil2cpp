...
__attribute__ ((visibility ("default"))) void il2cpp_memory_pool_set_region_size (size_t size);;
__attribute__ ((visibility ("default"))) size_t il2cpp_memory_pool_get_region_size ();;
...
__attribute__ ((visibility ("default"))) const FieldInfo* il2cpp_field_get_from_reflection (const Il2CppReflectionField * field);;
...
__attribute__ ((visibility ("default"))) Il2CppReflectionField* il2cpp_field_get_object (FieldInfo * field, Il2CppClass * refclass);;
...
__attribute__ ((visibility ("default"))) Il2CppGCHandle il2cpp_gchandle_new (Il2CppObject * obj, uint8_t pinned);;
__attribute__ ((visibility ("default"))) Il2CppGCHandle il2cpp_gchandle_new_weakref (Il2CppObject * obj, uint8_t track_resurrection);;
__attribute__ ((visibility ("default"))) Il2CppObject* il2cpp_gchandle_get_target (Il2CppGCHandle gchandle);;
__attribute__ ((visibility ("default"))) void il2cpp_gchandle_free (Il2CppGCHandle gchandle);;
